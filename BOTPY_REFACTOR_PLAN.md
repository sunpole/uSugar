...
- вынесено за шаг `1.2.2`: `33` физические строки из `bot.py`;
...
| Вспомогательные helper-функции | 42-190 | URL builders, protocol summary, timestamp formatting, saved sugar text, follow-up text |
