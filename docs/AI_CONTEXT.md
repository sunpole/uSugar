...
Текущая версия проекта по активной документации: `1.2.4`
...
- дальнейшее разбиение крупного `bot.py` на handlers/services после system/profile/info/glucose/settings handler шагов.
