...
Текущая версия проекта по активной документации: `1.2.5`
...
- дальнейшее разбиение крупного `bot.py` на handlers/services после system/profile/info/glucose/settings/logs handler шагов.
